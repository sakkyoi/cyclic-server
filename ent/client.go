...
// QueryRecords queries the records edge of a Payment.
func (c *PaymentClient) QueryRecords(pa *Payment) *RecordQuery {
...
// QueryPayment queries the payment edge of a Record.
func (c *RecordClient) QueryPayment(r *Record) *PaymentQuery {
...
type (
	hooks struct {
		Payment, Plan, Record, Subscription, User []ent.Hook
	}
	inters struct {
		Payment, Plan, Record, Subscription, User []ent.Interceptor
	}
)
