...
func (pc *PaymentCreate) SetName(s string) *PaymentCreate {
	pc.mutation.SetName(s)
	return pc
}

// SetDetails sets the "details" field.
func (pc *PaymentCreate) SetDetails(s string) *PaymentCreate {
...
func (pc *PaymentCreate) SetRecordsID(id uuid.UUID) *PaymentCreate {
	pc.mutation.SetRecordsID(id)
	return pc
}

// SetNillableRecordsID sets the "records" edge to the Record entity by ID if the given value is not nil.
func (pc *PaymentCreate) SetNillableRecordsID(id *uuid.UUID) *PaymentCreate {
	if id != nil {
		pc = pc.SetRecordsID(*id)
	}
	return pc
}

// SetRecords sets the "records" edge to the Record entity.
func (pc *PaymentCreate) SetRecords(r *Record) *PaymentCreate {
	return pc.SetRecordsID(r.ID)
}
...
func (pc *PaymentCreate) check() error {
	...
	if _, ok := pc.mutation.Details(); !ok {
		return &ValidationError{Name: "details", err: errors.New(`ent: missing required field "Payment.details"`)}
	}
	if _, ok := pc.mutation.CreatedAt(); !ok {
