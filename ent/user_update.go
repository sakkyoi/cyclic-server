...
func (uu *UserUpdate) RemovePlanIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.PasswordCleared() {
		_spec.ClearField(user.FieldPassword, field.TypeBytes)
	}
...
// RemovePlanIDs removes the "plans" edge to Plan entities by IDs.
func (uuo *UserUpdateOne) RemovePlanIDs(ids ...uuid.UUID) *UserUpdateOne {
